...
// Source: github.com/solo-io/gloo-mesh/pkg/openmeshctl/commands/uninstall (interfaces: Context)

// Package mock_uninstall is a generated GoMock package.
package mock_uninstall
