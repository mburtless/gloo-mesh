...
type RateLimitServerConfigEventHandlerFuncs struct {
	OnCreate  func(obj *networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig) error
	OnUpdate  func(old, new *networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig) error
	OnDelete  func(obj *networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig) error
	OnGeneric func(obj *networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig) error
}
...
func NewRateLimitServerConfigEventWatcher(name string, mgr manager.Manager) RateLimitServerConfigEventWatcher {
	return &rateLimitServerConfigEventWatcher{
		watcher: events.NewWatcher(name, mgr, &networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig{}),
	}
}
...
func (h genericRateLimitServerConfigHandler) Create(object client.Object) error {
	obj, ok := object.(*networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig)
	if !ok {
...
func (h genericRateLimitServerConfigHandler) Update(old, new client.Object) error {
	objOld, ok := old.(*networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig)
	if !ok {
		return errors.Errorf("internal error: RateLimitServerConfig handler received event for %T", old)
	}
	objNew, ok := new.(*networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig)
	if !ok {
