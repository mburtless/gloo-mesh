...
func makeGenericRateLimitServerConfigSet(rateLimitServerConfigList []*networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig) sksets.ResourceSet {
	var genericResources []ezkube.ResourceId
...
func NewRateLimitServerConfigSetFromList(rateLimitServerConfigList *networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfigList) RateLimitServerConfigSet {
	list := make([]*networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig, 0, len(rateLimitServerConfigList.Items))
...
func (s *rateLimitServerConfigSet) List(filterResource ...func(*networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig) bool) []*networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	for _, filter := range filterResource {
		genericFilters = append(genericFilters, func(obj ezkube.ResourceId) bool {
			return filter(obj.(*networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig))
		})
	}

	objs := s.Generic().List(genericFilters...)
	rateLimitServerConfigList := make([]*networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig, 0, len(objs))
	for _, obj := range objs {
		rateLimitServerConfigList = append(rateLimitServerConfigList, obj.(*networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig))
	}
	return rateLimitServerConfigList
}

func (s *rateLimitServerConfigSet) UnsortedList(filterResource ...func(*networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig) bool) []*networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig {
	if s == nil {
		return nil
	}
	var genericFilters []func(ezkube.ResourceId) bool
	...
	var rateLimitServerConfigList []*networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig
	for _, obj := range s.Generic().UnsortedList(genericFilters...) {
		rateLimitServerConfigList = append(rateLimitServerConfigList, obj.(*networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig))
	}
	return rateLimitServerConfigList
...
func (s *rateLimitServerConfigSet) Map() map[string]*networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig {
	if s == nil {
		return nil
	}

	newMap := map[string]*networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig{}
	for k, v := range s.Generic().Map() {
		newMap[k] = v.(*networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig)
	}
	return newMap
}

func (s *rateLimitServerConfigSet) Insert(
	rateLimitServerConfigList ...*networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig,
) {
	if s == nil {
		panic("cannot insert into nil set")
	}
...
func (s *rateLimitServerConfigSet) Find(id ezkube.ResourceId) (*networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig, error) {
	if s == nil {
		return nil, eris.Errorf("empty set, cannot find RateLimitServerConfig %v", sksets.Key(id))
	}
	obj, err := s.Generic().Find(&networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig{}, id)
	if err != nil {
		return nil, err
	}

	return obj.(*networking_enterprise_mesh_gloo_solo_io_v1beta1.RateLimitServerConfig), nil
}
