...
func (i *InputDiscoveryInputSnapshotManualBuilder) AddNamespaces(namespaces []*v1.Namespace) *InputDiscoveryInputSnapshotManualBuilder {
	i.namespaces.Insert(namespaces...)
	return i
}
