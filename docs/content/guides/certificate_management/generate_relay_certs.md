---
title: Manual Relay Certificates
menuTitle: Generating Relay Certificates
description: Manually generating certificates for the relay agents. 
weight: 30
---

Below is an example script to generate each relay certificate manually.

**Note** You need to set the relay agent DNS name to the same cluster name used when registering the cluster with the Gloo Mesh Management Plane.
