---
title: ACM Managed Certificates
menuTitle: Managing certificates with ACM
description: Using ACM to create and manage the root and intermediate CA certificates.
weight: 10
---
...
![ACM Root Cert]({{% versioned_link_path fromRoot="/img/certificates/acm-root-only.png" %}})

## Using ACM for Root CA and Relay Intermediate CA
...
![ACM Root and Intermediate Certs]({{% versioned_link_path fromRoot="/img/certificates/acm-roots.png" %}})
